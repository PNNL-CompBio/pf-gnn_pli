...
```python
python prepare_pic50_data.py <path to pkl-mol directory> <path to save numpy features>
```
```python
python prepare_eba_data.py <path to pkl-mol directory> <path to save numpy features>
```
**Training**
